...
{
    class DepthOfFieldScatter : ImageEffectBase
    {
        ...
        private bool CheckSupport(bool needDepth, bool needHDR = false)
        {
            isSupported = true;
        ...
        private bool CheckResources()
        {
            ...
            dofHdrMaterial = CheckShaderAndCreateMaterial(shader, dofHdrMaterial);
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            else if ((blurType == BlurType.DX11) && dx11bokehMaterial)
            {
                ...
                if (highResolution)
                {
                    ...
                    dx11bokehMaterial.SetVector("_BokehParams", new Vector4(dx11BokehScale, dx11BokehIntensity, Mathf.Clamp(dx11BokehThreshhold, 0.005f, 4.0f), internalBlurWidth));
